...
pub fn build() -> Router<AppState>
{
    Router::new()
        ...
        .route("/movies/{movie_id}/{property}/lock", post(movies::lock_property))
        .route("/movies/{movie_id}/{property}/unlock", post(movies::unlock_property))
        ...
        .route("/series/{series_id}/{property}/lock", post(series::lock_property))
        .route("/series/{series_id}/{property}/unlock", post(series::unlock_property))
